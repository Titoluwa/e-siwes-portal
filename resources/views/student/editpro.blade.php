                    ...
                    <form method="POST" action="/" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <!-- <input id="address_of_training" type="text" class="form-control @error('address_of_training') is-invalid @enderror" name="address_of_training" value="{{Auth::user()->address_of_training}}" required autocomplete="address_of_training" autofocus> -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <!-- <input id="duration_of_training" type="number" class="form-control @error('duration_of_training') is-invalid @enderror" name="duration_of_training" value="{{Auth::user()->duration_of_training}}" required autocomplete="duration_of_training" autofocus> -->
                        ...
                        <label class="col-form-label col-md-2" for="signature">Signature</label>
                            <div class="col-md-4">
                                <!-- <img src="{{asset('storage/'. Auth::user()->signature)}}" alt="" width="60" height="60"> -->
