...
<div>
    ...
    <table class="main-table" style="max-height: 30%;">
        ...
        <tr class="main-row">
            ...
            <td>
                <img src="{{asset('storage/'. $siwes->student->signature)}}" alt="signature" width="10%" height="3%">
            </td> 
        </tr>
    </table>
    <br>
    <p><b>Date: </b> <span class="inserted">{{Carbon\Carbon::now()->format('d/m/Y')}}</span></p>
    <p><b>Stamp and Signature: </b> <span class="inserted"><img src="{{asset('storage/'. $industry_supervisor->user->signature)}}" alt="signature" width="180" height="30"></span></p>
    <div id="watermark">
